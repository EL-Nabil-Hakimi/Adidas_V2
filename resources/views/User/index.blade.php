...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="css/csskk.css">
   </head>
   ...
   <body>
      ...
      <div class="header_section header_bg">
         <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a href="/home" class="logo"><img style="width : 150px" src="https://turbologo.com/articles/wp-content/uploads/2019/07/Three-Bars-adidas-logo-1.jpg.webp"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="/produits">Our Cycle</a>
                  </li>
                  <li class="nav-item">
                     ...
                     <div class="container">
                        <div class="row">
                           ...
                           <div class="col-md-5">
                              ...
                              <div class="contact_bt"><a href="/contact">Shop Now</a></div>
                           </div>
                        </div>
                     </div>
                  </div>
      ...
      <div class="cycle_section layout_padding">
         ...
         <div class="container">
            <h1 class="cycle_taital">Les des produits</h1>
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
      ...
      $(document).ready(function () {
            $("#searshtext").keyup(function () {
                  ...
                  $.get("/searchpageUser/" + title, function (data) {
                     $("#MyDives").html(data);
                  });
            });
         });
